...
> *"Quick," said the mirror. "I must show you, my child.*
> *Step into the dark, a land's been beguiled."*
...
- **L5–8** — the mirror activates. *Foggy* + *bright* is the scrying-glass coming alive. *Far candlelight* = the kitchen-table soft-candle load that the previous draft made explicit, now compressed into a single image and held at distance. *"Quick," said the mirror. "I must show you, my child"* drops the soothing/lullaby register for urgency — the mirror summons the child as witness, not soothes her. The vocative *my child* establishes the device-as-elder / witness-as-pupil framing that scenes 2–6 will inhabit: each scene is a guided tour through the mirror's omniscient view. *A land's been beguiled* names the spell-state the book will catalogue across scenes 2–6, and widens the lens from a single soul to a captured polity — paid off immediately by the L9–12 montage, which names that land institution by institution (statehouses, banks, presidents, senators, courts, Washington's screens). The vague-then-specific move is the inverse of L1–2's specific-then-vague: the reader who knows the dossier hears *America*; the reader who doesn't hears *a land*. The perfect aspect — *'s been*, i.e. *has been*, not *is* — is theologically load-bearing: the deals are done; the book is forensic, not prophetic.
